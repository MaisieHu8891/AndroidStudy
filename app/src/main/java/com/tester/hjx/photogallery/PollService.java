...
public class PollService extends IntentService {
    ...
    public static final String NOTIFICATION = "NOTIFICATON";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        if(query == null){
            items = new FlickrFetchr().fetchIndexPhotos();
        }else {
            items = new FlickrFetchr().searchPhotos();
        }
        ...
        if(resultId.equals(lastResultId)){
            ...
            Notification notification = new NotificationCompat.Builder(this, "channel001")
